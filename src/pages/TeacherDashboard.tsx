      ...
      <header className="relative z-30 bg-white/70 backdrop-blur-2xl sticky top-0 border-b border-earth-brown/5 shadow-sm">
        <div className="container mx-auto px-6 h-24 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="font-black text-2xl text-nigerian-green leading-none tracking-tighter">Teacher Console</h1>
      ...
      <main className="relative z-10 container mx-auto px-6 pt-12">
        <div className="flex flex-col md:flex-row gap-6 mb-10 items-end">
          ...
          <div className="flex gap-4">
             <Card className="px-6 py-4 rounded-2xl border-earth-brown/5 shadow-kid flex items-center gap-3 bg-white/70 backdrop-blur-md">
        ...
        <div className="grid lg:grid-cols-4 gap-8">
          <div className="lg:col-span-3">
            <Card className="rounded-[2rem] border-earth-brown/5 shadow-kid overflow-hidden">
                       ...
                       <tr key={i} className="hover:bg-parchment/20 transition-colors">
                         <td className="px-6 py-4">
                           <div className="flex items-center gap-3">
                              <div className="w-9 h-9 rounded-full bg-nigerian-green/10 flex items-center justify-center text-nigerian-green font-black text-xs">
                                {s.name[0]}
                              </div>
                         ...
                         <td className="px-6 py-4">
                            <Button variant="ghost" size="sm" className="text-nigerian-green font-black rounded-xl">Details</Button>
                         </td>
                       </tr>
                     ))}
                   </tbody>
          ...
          <div className="space-y-6">
             <Card className="p-8 rounded-[2rem] border-adire-gold/20 bg-adire-gold/5 shadow-kid relative overflow-hidden">
             ...
             <Card className="p-8 rounded-[2rem] border-earth-brown/5 shadow-kid overflow-hidden relative">
